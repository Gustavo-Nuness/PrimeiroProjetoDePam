...
function carregarPagina($nomeClasse)
{
    ...
    else if (file_exists(__DIR__ . DIRECTORY_SEPARATOR . "controller" . DIRECTORY_SEPARATOR ."usuario".
    DIRECTORY_SEPARATOR. $nomeClasse . ".php")) {

        require_once(__DIR__ . DIRECTORY_SEPARATOR . "controller" . DIRECTORY_SEPARATOR ."usuario".
        DIRECTORY_SEPARATOR. $nomeClasse . ".php");
    }
}
